  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto w-full bg-background-light dark:bg-background-dark min-h-screen">
      <div className="mb-6 flex justify-between items-start">
        <div>
          <h2 className="text-[28px] font-bold text-text-primary mb-1">Teams</h2>
          <p className="text-text-secondary text-sm">Manage team organization and members.</p>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-border-subtle dark:divide-slate-800">
              {loading ? (
                ...
                teams.map((team) => (
                  <tr key={team.id} className="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-text-primary">{team.department}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-text-primary">{team.lead}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <span className="material-symbols-outlined text-text-muted mr-1 text-[16px]">person</span>
                        <span className="text-sm text-text-primary">{team.members}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      ...
                      <button className="text-text-secondary hover:text-text-primary font-medium transition-colors">Edit</button>
                    </td>
                  </tr>
                ))
              )}
